...
from datasets_eval.gt_res_dataset import GTResDataset


def parse_args():
    parser = ArgumentParser(add_help=False)
    parser.add_argument('--mode', type=str, default='lpips', choices=['lpips', 'l2', 'ssim'])
...
def run(args):
    ...
    result_str = 'Average loss is {}+-{:.2f}'.format(mean, std)
