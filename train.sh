...
# python -m torch.distributed.launch --nproc_per_node=1 --master_port=29504 train.py configs/stylegan_ffhq256_encoder_y.py --work_dir work_dirs/psp_reduced46
 python -m torch.distributed.launch --nproc_per_node=1 --master_port=29504 train.py configs/stylegan_ffhq256_encoder_y.py --work_dir work_dirs/psp_deformableconv