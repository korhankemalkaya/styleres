...
class E4E_Inversion(nn.Module):
    def __init__(self, resolution, e4e_path, num_layers = 50, mode='ir_se', out_res=64):
        ...
        in_channels = 128
        self.num_features = 1
        # self.highres = nn.ModuleList()

        # for i in range(self.num_features):
        #     out_channels = 512 #min(in_channels*2, 512)
        #     self.highres.append(HighResFeat(in_channels, out_channels))
