...
from runners.controllers import summary_writer
...
class RunningLogger(BaseController):
    ...
    def execute_after_iteration(self, runner):
        ...
        if self._tensorboard_format:
            summary_writer.log_data(log_data, runner)
            ...
            #     else:
            #         self.tensorboard_writer.add_scalar(name, value, global_step=runner.iter)
